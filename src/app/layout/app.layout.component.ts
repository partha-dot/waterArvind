...
export class AppLayoutComponent implements OnDestroy , OnInit{
            ...
            .subscribe(() => {
                ...
                this.hideProfileMenu();
                            ...
                            console.log(val instanceof NavigationEnd)
                                ...
                                this.org_id=localStorage.getItem("fastorgid");
    ...
    ngOnInit(): void {
        this.items = [
            { label: 'I/O', icon: 'pi pi-spin pi-fw pi-sync',routerLink: [`/app/outlet/${this.org_id}`] , visible:true},
            ...
            { label: 'device Info', icon: 'pi pi-fw pi-info-circle',routerLink: [`/app/outlet/${this.org_id}/water_devInfo`] ,visible:true },
            ...
            { label: 'Graphical View', icon: 'pi pi-fw pi-chart-pie',routerLink: [`/app/outlet/${this.org_id}/water_chart`], visible:true },
            ...
            { label: 'Historic Data', icon: 'pi pi-fw pi-book',routerLink: [`/app/outlet/${this.org_id}/report`],visible:true  },
