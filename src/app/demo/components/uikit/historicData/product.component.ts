...
export class ProductComponent implements OnInit{
  ...
  ngOnInit() {
    ...
    this.cols = [
      ...
      {field: 'flow_rate1',header:"Flow Rate", },

      {field: 'total_flow1', header:"Total Flow", },
    ...
    this.sourceProducts=[
      {field: 'flow_rate1',header:"Flow Rate 1", },
      {field: 'total_flow1', header:"Total Flow 1", },

      {field: 'flow_rate2',header:"Flow Rate 2", },
      {field: 'total_flow2', header:"Total Flow 2", },

      {field: 'flow_rate3',header:"Flow Rate 3", },
      {field: 'total_flow3', header:"Total Flow 3", },

      {field: 'flow_rate4',header:"Flow Rate 4", },
      {field: 'total_flow4', header:"Total Flow 4", },

      {field: 'flow_rate5',header:"Flow Rate 5", },
      {field: 'total_flow5', header:"Total Flow 5", },

      {field: 'flow_rate6',header:"Flow Rate 6", },
      {field: 'total_flow6', header:"Total Flow 6", },
...
const apiUrl = this.api.baseUrl;
  ...
  saveProduct() {
    ...
    this.device='';
      ...
      this.productDialog = false;
      this.http.post(apiUrl+'/client/report/water_flow_data', credentials,{ headers }).subscribe(
        (response) => {
          this.spinner=false;
          console.log(response);
          this.data1=response
